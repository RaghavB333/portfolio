        ...
        >
          <div className="flex flex-col lg:flex-row justify-between items-center gap-10 px-4 py-10">
            <div className="text-lg leading-relaxed max-w-xl">
              ...
              <br /><br />
              From winning one hackathon and reaching top 10 in another, to now setting out on an adventure in real world to solve as many real world problems with my skills, I am committed to learn, grow, solve and most importantly, code, with all my heart.
              <br /><br />
